...
import type { CustomerRecord, PriceRecord, QuoteItemRecord, QuoteRecord, WorkflowEventRecord } from "@/lib/schemas/shared-records";
...
type TestPriceApplication = { price_type?: PriceType };
type TestCommercialCalculation = { gross_margin_bps?: number };

type ResolvedLine = QuoteItemRecord & {
  metadata: QuoteItemRecord["metadata"] & {
    price_application?: TestPriceApplication | null;
  };
};
...
const workflowEvent: WorkflowEventRecord & { idempotency_key: string | null } = {
